...
registerChart({
  ...
  dataHint: 'First column = x-axis labels, each additional column = a stacked area series.',
  dataExample: 'Quarter, AI, Crypto, Fintech\nQ1 \'24, 120, 80, 60\nQ2 \'24, 180, 110, 75',
  dataJsonHint: 'Provide labels array and multiple datasets. Each dataset becomes a stacked area series.',
  dataJsonExample: '{\n  "labels": ["Q1 \'24", "Q2 \'24", "Q3 \'24"],\n  "datasets": [\n    { "name": "AI", "values": [120, 180, 240] },\n    { "name": "Crypto", "values": [80, 110, 150] },\n    { "name": "Fintech", "values": [60, 75, 95] }\n  ]\n}',
  isSelfManaged: false,
