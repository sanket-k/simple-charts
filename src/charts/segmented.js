...
registerChart({
  ...
  dataHint: 'First column = group names, other columns = segment labels. Values support ~ and % prefixes/suffixes. JSON: top-level keys = groups, inner keys = segments.',
  dataExample: 'Category, NMC, LFP, Other\n2020, 70, 25, 5\n2025, 45, 50, 5',
  dataJsonHint: 'JSON: top-level keys = group names, inner keys = segment labels, values = numbers. CSV: first column = group names, headers = segment labels. Values support ~ and % prefixes/suffixes.',
  dataJsonExample: '{\n  "2020": { "NMC": 70, "LFP": 25, "Other": 5 },\n  "2025": { "NMC": 45, "LFP": 50, "Other": 5 }\n}',
  isSelfManaged: true,
