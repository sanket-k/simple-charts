...
registerChart({
  ...
  dataHint: 'First series = foreground bar (solid), second series = background bar (faded). Requires exactly 2 data series. Uses logarithmic scale — values must be positive.',
  dataExample: 'Metric, Before, After\nHorsepower, 10, 430\nTop Speed, 35, 120\nRange, 150, 700',
  dataJsonHint: 'Provide labels and exactly 2 datasets (foreground and background bars). Values must be positive (log scale).',
