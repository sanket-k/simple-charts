...
registerChart({
  ...
  dataHint: 'First series = left bubbles, second series = right bubbles. Requires exactly 2 data series. Bubble area is proportional to value. Larger values = bigger circles.',
  dataExample: 'Metric, Before, After\nHorsepower, 10, 430\nTop Speed, 35, 120\nRange, 150, 700',
  dataJsonHint: 'Provide labels and exactly 2 datasets. Bubble area is proportional to value. Values must be positive.',
  dataJsonExample: '{\n  "labels": ["Horsepower", "Top Speed", "Range", "Towing"],\n  "datasets": [\n    { "name": "Before", "values": [10, 35, 150, 10] },\n    { "name": "After", "values": [430, 120, 700, 13500] }\n  ]\n}',
  isSelfManaged: true,
