...
registerChart({
  ...
  dataHint: 'First series = left dots, second series = right dots. Requires exactly 2 data series. Values must be positive (logarithmic scale). Ratio labels show After / Before.',
  dataExample: 'Metric, Before, After\nHorsepower, 10, 430\nTop Speed, 35, 120\nRange, 150, 700',
  dataJsonHint: 'Provide labels and exactly 2 datasets (Before and After). Values must be positive (log scale).',
